...
.legend-dot.revenue-color { background: var(--color-text-primary); }
.legend-dot.cost-color { background: #ef4444; }

/* 240px minmax retained: global .stats-grid uses 280px which wraps to 3 cols at ~1000px
   content width (typical with sidebar). 4 * 240 + 3 * 20 = 1020px keeps all 4 KPIs inline. */
.stats-grid-finance {
  display: grid;
